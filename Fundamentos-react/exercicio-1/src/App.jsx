export default function App(){
  return (
    <div>
      ...
      <button>Aprenda React</button><button>Referências da API</button>
      <hr />

      <h2>Crie interfaces de usuários de componentes</h2>

      <p>React permite que você contrua interfaces de usuário a partir de pedaços individuais chamados componentes</p>
      <hr />

      <h2>Escreva componentes com código e marcação</h2>

      <p>Componentes Reacts são funções JavaScript. A sintaxe de marcação é chamada de JSX. É uma extensão da sintaxe JavaScript popularizada pelo React.</p>
      <hr />
